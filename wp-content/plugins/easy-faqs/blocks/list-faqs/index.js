( 
	 ...
	 */
	registerBlockType( 'easy-faqs/list-faqs', {
		/**
		...
		edit: wp.data.withSelect( function( select ) {
					return {
						...
						// add FAQs Per Page options panel
						var count_fields = [];
						...
						inspector_controls.push( 
							el (
								wp.components.PanelBody,
								{
									title: __('Number of FAQs To Display'),
									className: 'gp-panel-body',
									initialOpen: false,
									onToggle: update_paginate_panel,
								},
								el('div', { className: 'janus_editor_field_group janus_editor_field_group_no_heading' }, count_fields)
							)
						);
						...
						inner_fields.push( el('blockquote', { className: 'faq-list-placeholder' }, __('A list of FAQs from your database.') ) );
						retval.push( el('div', {'className': 'easy-faqs-editor-not-selected'}, inner_fields ) );

				return el( 'div', { className: 'easy-faqs-list-faqs-editor'}, retval );
